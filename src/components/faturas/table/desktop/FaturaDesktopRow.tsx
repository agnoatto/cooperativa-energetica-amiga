...
interface FaturaDesktopRowProps {
  ...
  onViewPdf?: () => void; // Propriedade opcional simplificada
}
    ...
    <>
      <TableRow className="hover:bg-gray-50" onClick={handleRowClick}>
        ...
        <TableCell className="py-3 px-4 text-sm text-center w-[150px]" onClick={(e) => e.stopPropagation()}>
          <ArquivoConcessionaria 
            arquivoPath={fatura.arquivo_concessionaria_path} 
            onViewPdf={onViewPdf || handleViewConcessionaria} 
          />
        </TableCell>
      ...
      {/* Visualizador de PDF separado para a visualização da concessionária */}
