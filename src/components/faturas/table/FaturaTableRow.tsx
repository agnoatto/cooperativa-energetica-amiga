  ...
  return (
    <>
      <TableRow className="border-b hover:bg-gray-50 transition-colors">
        <TableCell className="font-medium">{fatura.unidade_beneficiaria.cooperado.nome}</TableCell>
        ...
        <TableCell className="text-right font-mono">{fatura.consumo_kwh} kWh</TableCell>
        <TableCell className="text-right font-mono">{formatCurrency(fatura.total_fatura)}</TableCell>
        <TableCell className="text-right font-mono">{formatCurrency(fatura.fatura_concessionaria)}</TableCell>
        <TableCell className="text-right font-mono">{fatura.unidade_beneficiaria.percentual_desconto}%</TableCell>
        <TableCell className="text-right font-mono">{formatCurrency(fatura.valor_desconto)}</TableCell>
